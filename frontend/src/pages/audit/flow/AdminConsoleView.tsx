...
import type { User, UserRole, AuditUniverseEntity, AnnualPlanItem, Engagement, Finding, ComplianceControl, SystemLog } from '../../../types/audit_flow';
...
export default function AdminConsoleView() {
  ...
  const [activeAdminTab, setActiveAdminTab] = useState<'users' | 'roles' | 'universe' | 'templates' | 'taxonomy' | 'units' | 'system' | 'responsibilities' | 'standards' | 'policies'>('users');
