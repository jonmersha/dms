  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-white font-sans">
      <div className="bg-blue-800 py-16 text-white text-center">
        <h1 className="text-4xl font-extrabold sm:text-5xl">Quality Management</h1>
        <p className="mt-4 text-xl text-blue-100 max-w-3xl mx-auto">
          Our Quality Assurance and Improvement Program (QAIP) is designed to enable an evaluation of the internal audit activity's conformance with the Standards.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Commitment to Excellence</h2>
            <p className="text-gray-600 mb-4 text-lg">
              We believe that quality is not a destination, but a continuous journey. Our QAIP covers all aspects of the internal audit activity and continuously monitors its effectiveness.
            </p>
            <p className="text-gray-600 mb-8">
              The program includes periodic internal and external quality assessments and ongoing internal monitoring. Each part of the program is designed to help the internal audit activity add value and improve organizational operations.
            </p>
