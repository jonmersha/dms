...
export default function IrregularityRegistryView() {
  ...
  const handleCreate = async () => {
    if (!formData.branchId || !formData.caseDescription || !formData.discoveryTime || !formData.categoryId) {
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Resp: {report.responsibleOrganName || 'Unknown'}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <p className="font-bold text-gray-800">{report.categoryName}</p>
